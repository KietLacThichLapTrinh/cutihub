...
ImageButton.Image = "rbxassetid://16164580209"
...
if Third_Sea then
   ...
   ToggleTW:OnChanged(function(Value)
    ...
    local ToggleElite = Tabs.Main:AddToggle("ToggleElite", {Title = "Tự động kill Elite", Default = false })
...
local ToggleSeaBeAst = Tabs.Main:AddToggle("ToggleSeaBeAst", {Title = "Tự động đánh seabeast", Default = false })
...
local ToggleAutoW = Tabs.Main:AddToggle("ToggleAutoW", {Title = "Tự động nhấn phím W", Default = false })
...
local ToggleMirage = Tabs.Main:AddToggle("ToggleMirage", {Title = "Tự động đảo bí ẩn", Default = false })
...
for _,v in next, workspace.Boats.MarineBrigade:GetDescendants() do
 ...
 local AutoW = Tabs.Main:AddToggle("AutoW", {Title = "Tự nhấn phím W", Default = false })
 AutoW:OnChanged(function(Value)
  ...
  spawn(function()
    ...
    local ToggleHallow = Tabs.Main:AddToggle("ToggleHallow", {Title = "Tự động lấy lưỡi hái bóng tối[FULL]", Default = false })
	...
	spawn(function()
        ...
        local ToggleFactory = Tabs.Main:AddToggle("ToggleFactory", {Title = "Tự động đập nhà máy", Default = false })
...
CamShake:Stop()
    ...
    local ToggleBringMob = Tabs.Setting:AddToggle("ToggleBringMob", {Title = "Gom quái", Default = true })
...
local ToggleRemove = Tabs.Setting:AddToggle("ToggleRemove", {Title = "Xóa hiển thị dame", Default = true })
...
Tabs.Player:AddButton({
    Title = "Reset danh sách người chơi",
...
local ToggleTeleport = Tabs.Player:AddToggle("ToggleTeleport", {Title = "Tp đến người chơi", Default = false })
...
local ToggleFruit = Tabs.Fruit:AddToggle("ToggleFruit", {Title = "Mua trái ác quỷ từ shop", Default = false })
ToggleFruit:OnChanged(function(Value)
...
local ToggleStore = Tabs.Fruit:AddToggle("ToggleStore", {Title = "Cất trái ác quỷ", Default = false })
...
local ToggleRandomFruit = Tabs.Fruit:AddToggle("ToggleRandomFruit", {Title = "Quay trái ác quỷ", Default = false })
...
local ToggleCollect = Tabs.Fruit:AddToggle("ToggleCollect", {Title = "Nhặt trái ác quỷ", Default = false })
...
local ToggleEspFruit = Tabs.Fruit:AddToggle("ToggleEspFruit", {Title = "Esp Trái Ác Quỷ", Default = false })
...
local ToggleAwake = Tabs.Raid:AddToggle("ToggleAwake", {Title = "Tự động thức tỉnh chiêu", Default = false })
...
local ToggleGetFruit = Tabs.Raid:AddToggle("ToggleGetFruit", {Title = "Lấy fruit ít tiền", Default = false })
...
local ToggleLaw = Tabs.Raid:AddToggle("ToggleLaw", {Title = "Tự động đập law", Default = false })
...
Tabs.Race:AddParagraph({
    Title = "Tự động up tộc",
    Content = ""
})


Tabs.Race:AddButton({
    Title = "Tp đến cửa up tộc",
    Description = "",
    Callback = function()
        Game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(28286.35546875, 14895.3017578125, 102.62469482421875) 
        wait(0.1)
...
local ToggleHumanandghoul = Tabs.Race:AddToggle("ToggleHumanandghoul", {Title = "Tự động up tộc Human and Quỷ", Default = false })
...
local ToggleAutotrial = Tabs.Race:AddToggle("ToggleAutotrial", {Title = "Tự động up tộc", Default = false })
